...
- [ ] Select the stable real-data song/version fixture used for `LD-01`
- [ ] Execute first full `LD-01` run against the current baseline
- [ ] Package evidence artifacts outside tracked source and attach run metadata
...
- Checkpoint P3.2: fixture frozen for repeatable reruns
- Checkpoint P3.3: first clean `LD-01` evidence pack captured
...
Phase 3 active. Next checkpoint: freeze the `LD-01` fixture and capture the first clean evidence pack under the canonical runbook.

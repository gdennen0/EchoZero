...
local function init()
    ...
    local api = {
        ...
        {"EZ.CreateStaticPreset", EZ.CreateStaticPreset},
        {"EZ.CreatePhaserPreset", EZ.CreatePhaserPreset},
        {"EZ.CreateRecipePreset", EZ.CreateRecipePreset},
        {"EZ.EditStaticPreset", EZ.EditStaticPreset},
        {"EZ.EditPhaserPreset", EZ.EditPhaserPreset},
        {"EZ.EditRecipePreset", EZ.EditRecipePreset},
        {"EZ.ListPresets", EZ.ListPresets},
        {"EZ.DescribePreset", EZ.DescribePreset},
        {"EZ.PreviewReplacePresetWhenGroup", EZ.PreviewReplacePresetWhenGroup},
        {"EZ.ReplacePresetWhenGroup", EZ.ReplacePresetWhenGroup},
        {"EZ.GetEvents",     EZ.GetEvents},
        {"EZ.GetSequences",  EZ.GetSequences},
        {"EZ.Version", EZ.Version},
        {"EZ.SetTargetPopup", EZ.SetTargetPopup},
        {"EZ.Play", EZ.Play},
        {"EZ.PlayPause", EZ.PlayPause},
        {"EZ.Pause", EZ.Pause},
        {"EZ.Stop", EZ.Stop},
        {"EZ.JumpToPreviousSection", EZ.JumpToPreviousSection},
        {"EZ.JumpToNextSection", EZ.JumpToNextSection},

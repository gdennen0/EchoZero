...
def build_extract_song_drum_events(
    ...
    include_drums_stem_layer=True,
    include_bass_stem_layer=True,
    include_vocals_stem_layer=True,
    include_other_stem_layer=True,
    kick_model_path="",
    snare_model_path="",
    clap_model_path="",
    cymbal_model_path="",
    ...
    clap_filter_enabled=False,
    clap_filter_freq=1_200.0,
    clap_onset_threshold=0.15,
    cymbal_filter_enabled=False,
    cymbal_filter_freq=3_200.0,
    cymbal_onset_threshold=0.15,

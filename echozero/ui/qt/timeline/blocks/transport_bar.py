...
class TransportLayout:
    ...
    def create(
        *,
        ...
        controls_width = min(190.0, max(126.0, inner_width * 0.22))
        ...
        if remaining_after_controls > section_gap:
            ...
            clock_pref_width = 210.0
            clock_min_width = 84.0
            meta_min_width = 80.0
        ...
        return TransportLayout(
            ...
            time_rect=centered_rect(time_x, time_width, 26.0),
            meta_rect=centered_rect(meta_x, meta_width, 24.0),
        )

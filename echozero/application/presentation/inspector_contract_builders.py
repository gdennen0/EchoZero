"""Inspector contract builders for timeline object identities.
Exists to keep object-specific contract assembly out of the public routing entrypoint.
Connects resolved presentation selections to stable inspector sections and actions.
"""
...
def build_empty_contract(
    ...
    *,
    ...
    """Build the fallback contract when no concrete timeline object is selected."""
...
def build_song_version_contract(
    presentation: TimelinePresentation,
    *,
    hit_target: TimelineInspectorHitTarget | None,
    has_selected_events: bool,
) -> InspectorContract:
    """Build the inspector contract for the active song version fallback state."""
...
def build_layer_contract(
    ...
    *,
    ...
    """Build the inspector contract for a selected layer."""
...
def build_take_contract(
    ...
    *,
    ...
    """Build the inspector contract for a selected subordinate take."""
...
def build_event_contract(
    ...
    *,
    ...
    """Build the inspector contract for a selected event."""

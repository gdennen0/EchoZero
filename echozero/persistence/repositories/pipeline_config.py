"""
PipelineConfigRepository: CRUD for PipelineConfig entities in SQLite.
...
class PipelineConfigRepository(BaseRepository[PipelineConfig]):
    """Read and write PipelineConfig entities to the pipeline_configs table."""

    def _from_row(self, row: sqlite3.Row) -> PipelineConfig:
        """Convert a database row to a PipelineConfig entity."""
    ...
    def list_by_version(self, song_version_id: str) -> list[PipelineConfig]:
    ...
    def list_by_template(self, template_id: str) -> list[PipelineConfig]:

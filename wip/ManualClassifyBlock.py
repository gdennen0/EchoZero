...
class ManualClassifyBlock(Block):
    ...
    def register_layout(self):
        """
        Called once when the block is initialized/added to the project.
        Uses the parent's Dash app (self.parent.app) to define
        layout content and callbacks. Typically invoked in Project.add_block().
        """

        app = self.parent._app
        # Build & store the entire layout (was previously in register_ui):
        ...
        # If you're using dash.register_page, you can do something like:

...
class BlockTypeRegistry:
    ...
    def initialize_default_types(self):
        ...
        # Plot Events - Executable block
        self.register(BlockTypeMetadata(
            name="Plot Events",
            type_id="PlotEvents",
            description="Create matplotlib timeline visualizations of event data (notes, onsets, etc.)",
            execution_mode="executable",
            inputs={"events": EVENT_TYPE},
            tags=["visualization", "plot", "timeline", "matplotlib", "events", "notes"],
            commands=[
                {
                    "name": "set_output_dir",
                    "usage": "set_output_dir <directory>",
                    "description": "Set directory where visualizations will be saved",
                    "arguments": [
                        {
                            "name": "directory",
                            "required": True,
                ...
                {
                    "name": "set_plot_style",
                    "usage": "set_plot_style <bars|markers|piano_roll>",
                    "description": "Set visualization style",
                    "arguments": [
                        {
                            "name": "style",
                            "required": True,
                            "source": "positional",
                            "description": "Plot style: bars, markers, or piano_roll"
                        }
                    ]
                },
                {
                    "name": "set_figsize",
                    "usage": "set_figsize <width> <height>",
                    "description": "Set figure dimensions in inches",
                    "arguments": [
                        {
                            "name": "width",
                            "required": True,
                ...
                },
                {
                    "name": "set_dpi",
                    "usage": "set_dpi <value>",
                    "description": "Set output image resolution (default: 150)",
                    "arguments": [
                        {
                            "name": "value",
                            "required": True,
                ...
                {
                    "name": "show_labels",
                    "usage": "show_labels <true|false>",
                    "description": "Show/hide event labels on plot",
                    "arguments": [
                        {
                            "name": "enabled",
                            "required": True,
                ...
                {
                    "name": "show_grid",
                    "usage": "show_grid <true|false>",
                    "description": "Show/hide grid on plot",
                    "arguments": [
                        {
                            "name": "enabled",
                            "required": True,

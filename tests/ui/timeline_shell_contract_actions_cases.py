from tests.ui.timeline_shell_support import (
    ...
    test_contract_extract_classified_drums_opens_confirmation_settings_before_run,
    test_contract_extract_song_drum_events_opens_confirmation_settings_before_run,
